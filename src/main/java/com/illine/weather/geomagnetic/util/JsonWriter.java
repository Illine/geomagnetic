...
public final class JsonWriter {
    ...
    private static JavaTimeModule configureTimeModule() {
        ...
        module.addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(LocalTimeFormatter.DEFAULT_DATE_TIME_FORMATTER));
        module.addSerializer(LocalDate.class, new LocalDateSerializer(LocalTimeFormatter.DEFAULT_DATE_FORMATTER));
        module.addSerializer(LocalTime.class, new LocalTimeSerializer(LocalTimeFormatter.DEFAULT_TIME_FORMATTER));
        return module;
    }
}