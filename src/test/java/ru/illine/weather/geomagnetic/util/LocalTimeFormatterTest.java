package ru.illine.weather.geomagnetic.util;
...
import static ru.illine.weather.geomagnetic.util.LocalTimeFormatter.formatToString;
...
class LocalTimeFormatterTest {
    ...
    void successfulDateFormatToString() {
        var actual = LocalTimeFormatter.formatToString(DEFAULT_LOCAL_DATE);
    ...
    void successfulTimeFormatToString() {
        var actual = LocalTimeFormatter.formatToString(DEFAULT_LOCAL_TIME);
    ...
    void successfulDateTimeFormatToString() {
        var actual = LocalTimeFormatter.formatToString(DEFAULT_LOCAL_DATE_TIME);
    ...
    void successfulDateFormatFormatterToString() {
        ...
        var actual = LocalTimeFormatter.formatToString(DEFAULT_LOCAL_DATE, DateTimeFormatter.ofPattern("yyyy.MM.dd"));
    ...
    void successfulTimeFormatFormatterToString() {
        ...
        var actual = LocalTimeFormatter.formatToString(DEFAULT_LOCAL_TIME, DateTimeFormatter.ofPattern("ss:mm:HH"));
        assertEquals(expected, actual);
    }
    ...
    void successfulDateTimeFormatFormatterToString() {
        ...
        var actual = LocalTimeFormatter.formatToString(DEFAULT_LOCAL_DATE_TIME, DateTimeFormatter.ofPattern("ss:mm:HH yyyy.mm.dd"));
        assertEquals(expected, actual);
    }
}